<?php $__env->startSection('title', 'Ruangisasi - Pemesanan Jasa'); ?>
        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-8">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg me-2">Mulai Memesan</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg">Login</a>
                <?php else: ?>
                    <?php $dashboard = auth()->user()->role === 'super_admin' ? route('superadmin.dashboard') : (auth()->user()->role === 'admin' ? route('admin.dashboard') : route('user.dashboard')); ?>
                    <a href="<?php echo e($dashboard); ?>" class="btn btn-light btn-lg">Masuk Dashboard</a>
                <?php endif; ?>
            </div>
            <div class="col-lg-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\go_event12\resources\views/welcome.blade.php ENDPATH**/ ?>